 ...
 * not exist in php 7.4 The 'removed' section contains the signatures that were removed in php 8.0 The 'changed'
 * section contains functions for which the signature has changed for php 8.0. Each function in the 'changed' section
 * has an 'old' and a 'new' section, representing the function as it was in PHP 7.4 and in PHP 8.0, respectively
 *
 * @see CallMap.php
 *
