 ...
 * not exist in php 7.1 The 'removed' section contains the signatures that were removed in php 7.2. The 'changed'
 * section contains functions for which the signature has changed for php 7.2. Each function in the 'changed' section
 * has an 'old' and a 'new' section, representing the function as it was in PHP 7.1 and in PHP 7.2, respectively
 *
 * @see CallMap.php
 *
