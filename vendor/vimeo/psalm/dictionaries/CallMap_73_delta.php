 ...
 * The 'added' section contains function/method names from FunctionSignatureMap (And alternates, if applicable) that do
 * not exist in php 7.2 The 'removed' section contains the signatures that were removed in php 7.3. The 'changed'
 * section contains functions for which the signature has changed for php 7.3. Each function in the 'changed' section
 * has an 'old' and a 'new' section, representing the function as it was in PHP 7.2 and in PHP 7.3, respectively
 *
 * @see CallMap.php
 *
