...
<form id="oncore_mapping" class="container">
    ...
    <p class="lead">Data stored in OnCore will have a fixed nomenclature.  When linking an OnCore project to a REDCap project the analogous REDCap field name will need to be manually mapped and stored in the project's EM Settings.</p>
    <table class="table table-striped">
        ...
        <tfoot>
            <tr>
            <td colspan="3" align="right"><button type="submit" href="#" class="more-button">Save Mappings</button></td>
            </tr>
        </tfoot>
    </table>
</div>
